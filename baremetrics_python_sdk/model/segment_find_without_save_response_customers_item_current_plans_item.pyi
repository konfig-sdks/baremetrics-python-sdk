...
class SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def amounts() -> typing.Type['SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItemAmounts']:
                return SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItemAmounts
            __annotations__ = {
                "oid": oid,
                "source_id": source_id,
                "source": source,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["amounts"]) -> 'SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItemAmounts': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amounts"]) -> typing.Union['SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItemAmounts', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        amounts: typing.Union['SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItemAmounts', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'SegmentFindWithoutSaveResponseCustomersItemCurrentPlansItem':
