...
class RequiredSourceCreateChargeOneOffRequest(TypedDict):
...
class OptionalSourceCreateChargeOneOffRequest(TypedDict, total=False):
...
class SourceCreateChargeOneOffRequest(RequiredSourceCreateChargeOneOffRequest, OptionalSourceCreateChargeOneOffRequest):
    pass
