...
from baremetrics_python_sdk.pydantic.source_get_customer_details_response_customer_current_plans_item_amounts import SourceGetCustomerDetailsResponseCustomerCurrentPlansItemAmounts

class SourceGetCustomerDetailsResponseCustomerCurrentPlansItem(BaseModel):
    ...
    amounts: typing.Optional[SourceGetCustomerDetailsResponseCustomerCurrentPlansItemAmounts] = Field(None, alias='amounts')
