...
from baremetrics_python_sdk.pydantic.source_get_plan_response_plan_amounts import SourceGetPlanResponsePlanAmounts

class SourceGetPlanResponsePlan(BaseModel):
    ...
    amounts: typing.Optional[SourceGetPlanResponsePlanAmounts] = Field(None, alias='amounts')
