...
from baremetrics_python_sdk.pydantic.source_update_plan_response_plan_amounts import SourceUpdatePlanResponsePlanAmounts

class SourceUpdatePlanResponsePlan(BaseModel):
    ...
    amounts: typing.Optional[SourceUpdatePlanResponsePlanAmounts] = Field(None, alias='amounts')
