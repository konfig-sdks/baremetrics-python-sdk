...
from baremetrics_python_sdk.pydantic.source_get_customer_list_response_customers_item_current_plans_item_amounts import SourceGetCustomerListResponseCustomersItemCurrentPlansItemAmounts

class SourceGetCustomerListResponseCustomersItemCurrentPlansItem(BaseModel):
    ...
    amounts: typing.Optional[SourceGetCustomerListResponseCustomersItemCurrentPlansItemAmounts] = Field(None, alias='amounts')
