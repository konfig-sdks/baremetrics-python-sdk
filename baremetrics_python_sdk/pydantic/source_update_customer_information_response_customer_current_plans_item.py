...
from baremetrics_python_sdk.pydantic.source_update_customer_information_response_customer_current_plans_item_amounts import SourceUpdateCustomerInformationResponseCustomerCurrentPlansItemAmounts

class SourceUpdateCustomerInformationResponseCustomerCurrentPlansItem(BaseModel):
    ...
    amounts: typing.Optional[SourceUpdateCustomerInformationResponseCustomerCurrentPlansItemAmounts] = Field(None, alias='amounts')
