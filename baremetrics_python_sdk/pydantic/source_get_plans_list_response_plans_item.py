...
from baremetrics_python_sdk.pydantic.source_get_plans_list_response_plans_item_amounts import SourceGetPlansListResponsePlansItemAmounts

class SourceGetPlansListResponsePlansItem(BaseModel):
    ...
    amounts: typing.Optional[SourceGetPlansListResponsePlansItemAmounts] = Field(None, alias='amounts')
