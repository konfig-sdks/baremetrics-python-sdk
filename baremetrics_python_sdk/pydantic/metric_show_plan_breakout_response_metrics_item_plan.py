...
from baremetrics_python_sdk.pydantic.metric_show_plan_breakout_response_metrics_item_plan_amounts import MetricShowPlanBreakoutResponseMetricsItemPlanAmounts

class MetricShowPlanBreakoutResponseMetricsItemPlan(BaseModel):
    ...
    amounts: typing.Optional[MetricShowPlanBreakoutResponseMetricsItemPlanAmounts] = Field(None, alias='amounts')
