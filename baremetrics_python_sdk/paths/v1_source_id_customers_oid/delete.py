...
class BaseApi(api_client.Api):
    ...
    def _delete_customer_mapped_args(
        self,
        oid: str,
        source_id: str,
    ...
    async def _adelete_customer_oapg(
        self,
...
class DeleteCustomerRaw(BaseApi):
    ...
    async def adelete_customer(
        ...
        **kwargs,
        ...
        args = self._delete_customer_mapped_args(
            oid=oid,
            source_id=source_id,
        )
        return await self._adelete_customer_oapg(
    ...
    def delete_customer(
        ...
        return self._delete_customer_oapg(
            path_params=args.path,
        )

class DeleteCustomer(BaseApi):
    ...
    async def adelete_customer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_customer(
            oid=oid,
            source_id=source_id,
            **kwargs,
        )
    ...
    def delete_customer(
        ...
        raw_response = self.raw.delete_customer(
            oid=oid,
            source_id=source_id,
        )
        if validate:
