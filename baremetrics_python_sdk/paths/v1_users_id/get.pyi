...
from baremetrics_python_sdk.model.user_get_user_by_id_response import UserGetUserByIdResponse as UserGetUserByIdResponseSchema

from baremetrics_python_sdk.type.user_get_user_by_id_response import UserGetUserByIdResponse

from ...api_client import Dictionary
from baremetrics_python_sdk.pydantic.user_get_user_by_id_response import UserGetUserByIdResponse as UserGetUserByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserGetUserByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserGetUserByIdResponse
...
class GetUserById(BaseApi):
    ...
    async def aget_user_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserGetUserByIdResponsePydantic:
        raw_response = await self.raw.aget_user_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return UserGetUserByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UserGetUserByIdResponsePydantic, raw_response.body)
