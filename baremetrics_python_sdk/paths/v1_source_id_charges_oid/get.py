...
class BaseApi(api_client.Api):
    ...
    def _get_charge_details_mapped_args(
        self,
        source_id: str,
        oid: str,
    ...
    async def _aget_charge_details_oapg(
        self,
...
class GetChargeDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_charge_details(
        self,
        source_id: str,
        oid: str,
        **kwargs,
        ...
        args = self._get_charge_details_mapped_args(
            source_id=source_id,
            oid=oid,
        )
        return await self._aget_charge_details_oapg(
    ...
    def get_charge_details(
        ...
        return self._get_charge_details_oapg(
            path_params=args.path,
        )

class GetChargeDetails(BaseApi):
    ...
    async def aget_charge_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_charge_details(
            source_id=source_id,
            oid=oid,
            **kwargs,
        )
    ...
    def get_charge_details(
        ...
        raw_response = self.raw.get_charge_details(
            source_id=source_id,
            oid=oid,
        )
        if validate:
