...
class BaseApi(api_client.Api):
    ...
    def _remove_subscription_mapped_args(
        self,
        oid: str,
        source_id: str,
    ...
    async def _aremove_subscription_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/{source_id}/subscriptions/{oid}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveSubscriptionRaw(BaseApi):
    ...
    async def aremove_subscription(
        ...
        **kwargs,
        ...
        args = self._remove_subscription_mapped_args(
            oid=oid,
            source_id=source_id,
        )
        return await self._aremove_subscription_oapg(
    ...
    def remove_subscription(
        ...
        return self._remove_subscription_oapg(
            path_params=args.path,
        )

class RemoveSubscription(BaseApi):
    ...
    async def aremove_subscription(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_subscription(
            oid=oid,
            source_id=source_id,
            **kwargs,
        )
    ...
    def remove_subscription(
        ...
        raw_response = self.raw.remove_subscription(
            oid=oid,
            source_id=source_id,
        )
        if validate:
