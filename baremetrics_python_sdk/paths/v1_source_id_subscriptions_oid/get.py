...
class BaseApi(api_client.Api):
    ...
    def _get_subscription_mapped_args(
        self,
        oid: str,
        source_id: str,
    ...
    async def _aget_subscription_oapg(
        self,
...
class GetSubscriptionRaw(BaseApi):
    ...
    async def aget_subscription(
        ...
        **kwargs,
        ...
        args = self._get_subscription_mapped_args(
            oid=oid,
            source_id=source_id,
        )
        return await self._aget_subscription_oapg(
    ...
    def get_subscription(
        ...
        return self._get_subscription_oapg(
            path_params=args.path,
        )

class GetSubscription(BaseApi):
    ...
    async def aget_subscription(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_subscription(
            oid=oid,
            source_id=source_id,
            **kwargs,
        )
    ...
    def get_subscription(
        ...
        raw_response = self.raw.get_subscription(
            oid=oid,
            source_id=source_id,
        )
        if validate:
