...
class DeletePlanRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_plan(
        self,
        oid: str,
        source_id: str,
        **kwargs,
        ...
        args = self._delete_plan_mapped_args(
            oid=oid,
            source_id=source_id,
        )
        return await self._adelete_plan_oapg(
    ...
    def delete_plan(
        ...
        return self._delete_plan_oapg(
            path_params=args.path,
        )

class DeletePlan(BaseApi):
    ...
    async def adelete_plan(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_plan(
            oid=oid,
            source_id=source_id,
            **kwargs,
        )
    ...
    def delete_plan(
        ...
        raw_response = self.raw.delete_plan(
            oid=oid,
            source_id=source_id,
        )
        if validate:
