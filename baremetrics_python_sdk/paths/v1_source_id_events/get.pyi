...
# Query params
LiveStreamSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'live_stream': typing.Union[LiveStreamSchema, str, ],
...
request_query_live_stream = api_client.QueryParameter(
    name="live_stream",
...
class BaseApi(api_client.Api):
    ...
    def _get_events_mapped_args(
        self,
        source_id: str,
        live_stream: typing.Optional[str] = None,
        ...
        if live_stream is not None:
            _query_params["live_stream"] = live_stream
    ...
    async def _aget_events_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/{source_id}/events',
            auth_settings=_auth,
            headers=_headers,
        )
